...
<body class="bg-dark text-light">
    ...
    <div class="app-container">
      ...
      <h3 class="mb-4">Add New Cold Storage</h3>
      <form action="save_storage.php" method="POST" class="card p-4 shadow-sm">
        <div class="mb-3">
            <label class="form-label">Location</label>
            <input name="location" class="form-control" placeholder="e.g. Cold Storage A" required>
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="number" step="0.1" name="current_temp" class="form-control" required>
        </div>
        <div class="mb-3">
        ...
        <a href="dashboard-template.php" class="btn btn-secondary ms-2">Back to Dashboard</a>
    </form>
